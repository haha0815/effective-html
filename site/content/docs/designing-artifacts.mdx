...
skill for Claude Code. Anthropic's version includes a React artifact toolchain.
This version keeps the design guidance and makes it usable with any Effective
HTML artifact. It is maintained by Plannotator and is not an Anthropic skill.
...
<GuideHandoff
  ...
  artifactDescription="See all of the Effective HTML skills."
  ...
  sourceDescription="Read the Claude Code skill this version was based on."
  ...
  skillDescription="Give an HTML artifact a visual direction that fits the project."
/>
